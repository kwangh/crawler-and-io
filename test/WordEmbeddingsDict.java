...
public class WordEmbeddingsDict {
	...
	final static String dataPath = "G:\\SEONG'S RESEARCH\\Content Analysis\\AMR\\GoogleNews-vectors-negative300.bin";
	...
	public static void main(String[] args) {
		WordEmbeddingsDict wordEmbeddingsDict = new WordEmbeddingsDict("GoogleNews-vectors-negative300.bin");
		System.out.println("The word vector of 'apple'");
		float[] aVector = wordEmbeddingsDict.getWordVector("apple");
		System.out.printf("Length = %d\n", aVector.length);

		for (int m = 0; m < aVector.length; m++) {
			System.out.print(aVector[m]);
			System.out.print(" ");
		}
		...
		Set<WordEntry> cWordVec = wordEmbeddingsDict.distance("apple");
		int i = 0;

		for (WordEntry w : cWordVec) {
